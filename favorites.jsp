...
for (Meal.List m : meals) {
    if (m == null) {
    noFavs = "You currently have no items added to favorites.";
    db.close();
    break;
    }
...
<FORM METHOD="POST" id="add_favorite" ACTION="addMeal.jsp">
<INPUT TYPE="image" src="images/addFavorite.png" VALUE="Submit" /> 
<!--
